...
use crate::pacing::{FramePacer, RetransmitController};
use crate::timing::{RttEstimator, TimestampTracker};
...
impl ConnectionState {
    ...
    pub fn new(session_id: SessionId, remote_endpoint: SocketAddr) -> Self {
        ...
        Self {
            ...
            retransmit: RetransmitController::new(crate::timing::constants::INITIAL_RTO),
